...
In many cases, a functional agent needs to complete specific tasks, such as reading and writing data, calling APIs, or performing other deterministic operations. In Koog, you expose such capabilities as [tools](../../tools-overview/) and let the LLM decide when to call them.

Here is what you need to do:

1. Create an [annotation-based tool](../../annotation-based-tools/).
